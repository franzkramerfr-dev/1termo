...
Repositório central de estudos, focado no domínio dos fundamentos da programação e resolução de problemas utilizando Python.
...
Módulo 01: Fundamentos * Conceitos de lógica, tipos de variáveis e interação com o usuário (input/print).

Módulo 02: Tomada de Decisão

Controle de fluxo com estruturas condicionais (if, elif, else) e lógica booleana.

Módulo 03: Automação e Repetição

Laços de repetição inteligentes utilizando while e for.
